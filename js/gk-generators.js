...
GK_GEN2.geography = function() {
  ...
  var templates = [
    ...
    function() { if (!item[11]) return null; return {q: 'Which national park/wildlife sanctuary is in ' + item[0] + '?', a: item[11], hint: 'Many parks are located in specific geographic features', fact: item[0] + ' parks: ' + item[11]}; },
...
GK_GEN2.culture = function() {
  ...
  var templates = [
    ...
    function() { if (!item[4]) return null; return {q: 'Which period/dynasty saw the development of ' + item[0] + '?', a: item[4], hint: 'Mughal (miniature), Chola (bronze), Gupta (sculpture)', fact: item[0] + ' flourished in ' + item[4]}; },
...
GK_GEN2.world_geo = function() {
  ...
  var templates = [
    ...
    function() { if (!item[11]) return null; return {q: 'Which is the national animal/bird of ' + item[0] + '?', a: item[11], hint: 'India (tiger/peacock), USA (bald eagle), Australia (kangaroo)', fact: item[0] + ' symbol: ' + item[11]}; },
...
GK_GEN2.personalities = function() {
  ...
  var templates = [
    ...
    function() { if (!item[8]) return null; return {q: 'Which book/autobiography did ' + item[0] + ' write?', a: item[8], hint: 'Wings of Fire (Kalam), Discovery of India (Nehru), Gitanjali (Tagore)', fact: item[0] + ' wrote: ' + item[8]}; },
