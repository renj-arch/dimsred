...
function generatePatternQuestion(diff, focusType) {
  ...
  var answerMap = {
    ...
    'Pilot : Cockpit :: Captain : ?': { answer:'Ship', opts:['Ship','Plane','Train','Car'] },
    'Heat : Oven :: Cold : ?': { answer:'Fridge', opts:['Fridge','Ice','Freezer','Winter'] },
    ...
    'Find odd one: 25, 36, 49, 64, 72': { answer:'72', opts:['72','25','36','49'] },
    'Find odd one: 2, 3, 5, 7, 11, 13, 17': { answer:'2', opts:['2','11','13','17'] },
    ...
    '2, 5, 10, 17, 26, ?': { answer:'37', opts:['37','35','33','39'] },
    '1, 1, 2, 3, 5, 8, ?': { answer:'13', opts:['13','11','21','8'] },
    ...
    'If GO = 157, then COME = ?': { answer:'264', opts:['264','248','276','254'] },
    'If A=1, B=2, what is SUM?': { answer:'53', opts:['53','48','56','44'] },
    ...
    'All birds have feathers. Penguins are birds. Conclusion: Penguins have feathers.': { answer:'True', opts:['True','False','Cannot determine','Depends'] },
    'Some A are B. Some B are C. Conclusion: Some A are C.': { answer:'Cannot determine', opts:['True','False','Cannot determine','Depends'] },
    ...
    'A > B = C \u2265 D. Which is true?': { answer:'A > D', opts:['A > D','B = D','A = D','Cannot determine'] },
    'P = Q > R \u2264 S. Which is true?': { answer:'P > R', opts:['P > R','Q = S','P < R','Cannot determine'] },
    ...
    'A walks 10m East, turns left, walks 5m, turns left, walks 10m. Direction from start?': { answer:'West', opts:['West','East','North','South'] },
    'A walks 7m South, turns right, walks 3m, turns right, walks 7m. Direction from start?': { answer:'North', opts:['North','South','East','West'] },
    ...
    'A is B\'s mother. B is C\'s daughter. How is A related to C?': { answer:'Grandmother', opts:['Grandmother','Mother','Aunt','Sister'] },
    'P is Q\'s wife. Q is R\'s father. How is P related to R?': { answer:'Mother', opts:['Mother','Wife','Sister','Aunt'] },
    ...
    'Is x positive? Statement 1: x > y. Statement 2: y > 0.': { answer:'Both statements', opts:['Statement 1 alone','Statement 2 alone','Both statements','Neither statement'] },
    'What is x? Statement 1: x + y = 5. Statement 2: x - y = 1.': { answer:'Both statements', opts:['Statement 1 alone','Statement 2 alone','Both statements','Neither statement'] }
  };
