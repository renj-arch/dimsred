...
function fetchJSON(url, retries) {
  ...
  return new Promise(function(resolve, reject) {
    var req = https.get(url + '&origin=*', { agent: AGENT, headers: { 'User-Agent': 'AgriTechMiner/1.0 (contact: bot@vlymbooq.qzz.io)' } }, function(res) {
      var d = '';
...
var TOPICS = {
  ...
  'Surveying & Hydrology': ['Surveying', 'Hydrology', 'Level (instrument)'],
  'Soil & Watershed Conservation': ['Soil erosion', 'Soil conservation', 'Erosion control', 'Watershed management', 'Watershed', 'Check dam'],
  'Irrigation & Drainage Structures': ['Irrigation', 'Irrigation tank', 'Drainage', 'Drainage basin', 'Dam'],
  'Farm Power': ['Tractor', 'Draft animal', 'Agricultural machinery'],
  'Farm Machinery & Equipment': ['Agricultural machinery', 'Combine harvester', 'Plough', 'Harrow (tool)', 'Agricultural engineering'],
  'Food & Agricultural Processing': ['Food processing', 'Unit operation', 'Food preservation', 'Food industry', 'Milling (grinding)', 'Drying', 'Grain'],
  'Agricultural Engineering': ['Agricultural engineering', 'Tractor', 'Combine harvester', 'Irrigation sprinkler'],
  'Renewable & Bioenergy': ['Renewable energy', 'Bioenergy', 'Biogas', 'Solar energy', 'Wind power', 'Biomass'],
