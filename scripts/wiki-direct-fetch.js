...
const TARGETS = [
  ...
  ['w_battle', 'Category:Battles'],
  ['w_war', 'Category:Wars'],
  ['w_geyser', 'Category:Geysers'],
  ['w_harbor', 'Category:Ports_and_harbours'],
  ['w_treaty', 'Category:Treaties'],
  ['w_trench', 'Category:Oceanic_trenches'],
  ['w_empire', 'Category:Empires'],
  ['w_peak', 'Category:Mountains'],
  ['w_castle', 'Category:Castles'],
  ['w_cathedral', 'Category:Cathedrals'],
  ['w_embassy', 'Category:Diplomatic_missions'],
  ['w_hospital', 'Category:Hospitals'],
  ['w_park', 'Category:Parks'],
  ['w_reservoir', 'Category:Reservoirs'],
  ['w_school', 'Category:Schools'],
  ['w_shrine', 'Category:Shrines'],
  ['w_stadium', 'Category:Stadiums'],
  ['w_theatre', 'Category:Theatres'],
  ['w_tomb', 'Category:Tombs'],
  ['w_university', 'Category:Universities'],
];
