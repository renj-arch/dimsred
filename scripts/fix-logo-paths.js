...
for (var fi = 0; fi < files.length; fi++) {
  ...
  // Fix broken nav logo paths: ..logo.png -> ../logo.png
  html = html.replace(/src="\.\.logo\.png"/g, 'src="../logo.png"');
  // Fix broken nav logo paths for deeper: ....logo.png -> ../../logo.png (and longer)
  html = html.replace(/src="(\.\.)((?:\.\.)+)logo\.png"/g, function(m, d1, rest) {
    return 'src="' + d1 + '/' + rest + 'logo.png"';
  });
