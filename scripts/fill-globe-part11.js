...
const CAT_MAP = {
  ...
  'wiki-w_organization.json': 'w_organization',
  ...
  'wiki-w_philosopher.json': 'w_philosopher',
  'wiki-w_artist.json': 'w_artist',
  'wiki-w_architect.json': 'w_architect',
  ...
  'wiki-w_waterfall.json': 'w_waterfall',
  'wiki-w_volcano.json': 'w_volcano',
  'wiki-w_glacier.json': 'w_glacier',
  'wiki-w_forest.json': 'w_forest',
  'wiki-w_desert.json': 'w_desert',
  'wiki-w_lake.json': 'w_lake',
  'wiki-w_island.json': 'w_island',
  'wiki-w_bird.json': 'w_bird',
  'wiki-w_temple.json': 'w_temple',
  'wiki-w_sea.json': 'w_sea',
  'wiki-w_port.json': 'w_port',
  'wiki-w_plateau.json': 'w_plateau',
  'wiki-w_range.json': 'w_range',
  'wiki-w_reef.json': 'w_reef',
  'wiki-w_railway.json': 'w_railway',
  'wiki-w_highway.json': 'w_highway',
  'wiki-w_biosphere.json': 'w_biosphere',
  'wiki-w_ramsar.json': 'w_ramsar',
};
...
try {
  ...
  console.error('Post-write syntax had errors — continuing for downstream fix-apostrophes.js to handle');
} finally {
