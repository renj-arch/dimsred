...
const CATEGORIES = [
  ...
  { name:'International Organizations & Summits', wikiCat:'International_organizations', keywords:[
    ...
    'BIMSTEC','Indian Ocean Rim Association','Colombo Security Conclave','Mekong–Ganga Cooperation',
    'Forum for India–Pacific Islands Cooperation','East Asia Summit','Asian Infrastructure Investment Bank',
    'New Development Bank','Commonwealth of Nations','RCEP','Comprehensive and Progressive Agreement for Trans-Pacific Partnership',
    'G4 nations','Asia–Africa Growth Corridor','Indian Ocean Conference','Indo-Pacific Economic Framework','I2U2',
    'International Solar Alliance','Coalition for Disaster Resilient Infrastructure','Digital Public Infrastructure'
  ]},
  ...
  // ───────── PSIR optional + UPSC completeness: Political Theory, Thought & IR ─────────
  { name:'Political Theory & Concepts', wikiCat:'Political_theory', keywords:[
    'political','theory','state','sovereignty','right','justice','liberty','equality','democracy','governance','constitution','federalism','citizen','power','authority','legitimacy','welfare','pluralism','representation','legislature','executive','judiciary'
  ], topics:[
    'Political theory','State (polity)','Sovereignty','Nation state','Government','Democracy','Direct democracy','Representative democracy','Constitutionalism','Rule of law','Separation of powers','Federalism','Unitary state','Citizenship','Rights','Natural rights','Legal rights','Human rights','Justice','Social justice','Distributive justice','Equality','Liberty','Fraternity','Welfare state','Public opinion','Civil society','Social contract','Legitimacy','Power (social and political)','Authority','Totalitarianism','Authoritarianism','Totalitarian democracy','Pluralism (political theory)','Political participation','Political culture','Lobbying','Pressure group','Interest group','Elite theory','Political socialization','Legislature','Executive (government)','Judiciary','Parliamentary system','Presidential system','Veto','Bill (law)'
  ]},
  { name:'Western Political Thought', wikiCat:'Political_philosophy', keywords:[
    'philosophy','plato','aristotle','machiavelli','hobbes','locke','rousseau','kant','hegel','marx','political','state','contract','republic','leviathan','liberal','utilitarian','anarchism','socialism'
  ], topics:[
    'Plato','Republic (Plato)','Aristotle','Politics (Aristotle)','Nicomachean Ethics','Machiavelli','The Prince','Thomas Hobbes','Leviathan (Hobbes book)','John Locke','Two Treatises of Government','Montesquieu','The Spirit of the Laws','Jean-Jacques Rousseau','The Social Contract','Thomas More','Utopia (book)','Hugo Grotius','Jean Bodin','Jeremy Bentham','Utilitarianism','James Mill','John Stuart Mill','On Liberty','Georg Wilhelm Friedrich Hegel','Karl Marx','Das Kapital','The Communist Manifesto','Friedrich Engels','Vladimir Lenin','Rosa Luxemburg','Antonio Gramsci','Hannah Arendt','The Human Condition','Isaiah Berlin','John Rawls','A Theory of Justice','Robert Nozick','Anarchy, State, and Utopia','Martha Nussbaum','Amartya Sen','The Idea of Justice','John Austin (legal philosopher)','Legal positivism','State of nature','Social contract theory'
  ]},
  { name:'Indian Political Thought', wikiCat:'Political_philosophy_in_India', keywords:[
    'indian','bharat','kautilya','gandhi','ambedkar','nehru','lohia','upadhyay','political','thought','swaraj','satyagraha','trusteeship','radical humanism','socialist','dalit','sarvodaya','quintessential'
  ], topics:[
    'Kautilya','Arthashastra','Manusmriti','Tiruvalluvar','Thirukkural','Mahatma Gandhi','Hind Swaraj','Satyagraha','Swaraj','Trusteeship','B.R. Ambedkar','Annihilation of Caste','Jawaharlal Nehru','The Discovery of India','Maulana Abul Kalam Azad','Ram Manohar Lohia','Jayaprakash Narayan','Total Revolution','Deendayal Upadhyaya','Integral Humanism','Swami Vivekananda','Sri Aurobindo','M.N. Roy','Radical Humanism','Vinoba Bhave','Bhoodan movement','Subhas Chandra Bose','C. Rajagopalachari','Sarvepalli Radhakrishnan','Constituent Assembly of India','Objectives Resolution','Nehru Report','Gandhian economics','Sarvodaya','Individual Satyagraha','Quit India Movement','Indian independence movement philosophy'
  ]},
  { name:'Comparative Politics & World Constitutions', wikiCat:'Comparative_politics', keywords:[
    'comparative','constitution','parliamentary','presidential','westminster','federal','political system','electoral','proportional','semi-presidential','bicameral','unicameral','judicial review'
  ], topics:[
    'Comparative politics','Constitution','Uncodified constitution','Constitution of the United Kingdom','United States Constitution','Constitution of France','Constitution of Japan','Basic Law for the Federal Republic of Germany','Constitution of China','Constitution of Italy','Constitution of Australia','Westminster system','Parliamentary system','Presidential system','Semi-presidential system','Separation of powers','Fusion of powers','Electoral system','First-past-the-post voting','Two-round system','Proportional representation','Mixed-member proportional representation','Bicameralism','Unicameralism','Federalism','Judicial review','Constitutional court','Political party','Party system','Multi-party system','Two-party system','Dominant-party system','Political culture','Federalism in Germany'
  ]},
  { name:'International Relations Theory', wikiCat:'International_relations_theory', keywords:[
    'international','realism','liberalism','constructivism','balance','power','diplomacy','sovereignty','anarchy','security','deterrence','hegemony','geopolitics','dependency','regime','disarmament','nuclear','globalisation'
  ], topics:[
    'International relations','International relations theory','Realism (international relations)','Neorealism (international relations)','Liberalism (international relations)','Neoliberal institutionalism','Constructivism (international relations)','English school of international relations theory','Marxism (international relations)','Dependency theory','World-systems theory','Feminism in international relations','Postcolonialism','Balance of power (international relations)','Collective security','Deterrence theory','Mutual assured destruction','Diplomacy','Soft power','Hard power','Smart power','National interest','State sovereignty','Anarchy (international relations)','Hegemony','Polarity (international relations)','Unipolarity','Bipolarity','Multipolarity','Regionalism (international relations)','Geopolitics','Geo-economics','International regime','Regime theory','International law','Global governance','Disarmament','Arms control','Nuclear disarmament','Non-proliferation','Globalization','International security','Human security','Climate diplomacy','Digital diplomacy'
  ]},
  { name:'Internal Security & Counter-Terrorism', wikiCat:'Internal_security_of_India', keywords:[
    'security','terror','insurg','naxal','maoist','extremis','border','cyber','intelligence','narcotic','human trafficking','organised crime','militant','militancy','counter','internal','communal','unlawful','money laundering','hawala'
  ], topics:[
    'Internal security of India','Terrorism in India','Insurgency in Northeast India','Naxalite-Maoist insurgency','Left-wing extremism in India','Jammu and Kashmir insurgency','Khalistan movement','Religious violence in India','Organized crime in India','Money laundering','Hawala','Black money','Prevention of Money Laundering Act, 2002','Drug trafficking','Human trafficking in India','Arms trafficking','National Investigation Agency','National Security Guard','Research and Analysis Wing','Intelligence Bureau (India)','Central Bureau of Investigation','Border Security Force','Indo-Tibetan Border Police','Sashastra Seema Bal','Assam Rifles','CERT-In','Cybercrime in India','National Cyber Security Policy','Coastal security in India','MARCOS','Counter-terrorism','Crisis management','Narcotics in India'
  ]},
  { name:'Financial Regulators & Markets', wikiCat:'Financial_regulation_in_India', keywords:[
    'financial','market','stock','sebi','irdai','pfrda','nabard','regulator','insurance','pension','capital','exchange','mutual fund','bond','fdi','investment','deposit','npa','banking','reserve bank'
  ], topics:[
    'Securities and Exchange Board of India','Insurance Regulatory and Development Authority of India','Pension Fund Regulatory and Development Authority','National Bank for Agriculture and Rural Development','Financial Stability and Development Council','Reserve Bank of India','Monetary Policy Committee (India)','Deposit Insurance and Credit Guarantee Corporation','Insolvency and Bankruptcy Code','Non-performing asset','Capital market','Stock exchange','Bombay Stock Exchange','National Stock Exchange of India','Sensex','NIFTY 50','Mutual fund','Association of Mutual Funds in India','Debenture','Bond (finance)','Government bond','Corporate bond','Derivative (finance)','Futures contract','Options (finance)','Foreign direct investment','Foreign direct investment in India','Foreign institutional investor','Foreign Exchange Management Act','Foreign Investment Promotion Board','Bank rate','Repo rate','Cash reserve ratio','Statutory liquidity ratio','Base rate','Credit rating agency','Asset reconstruction company','Mudra loan','Financial inclusion','Payments bank','Small finance bank'
  ]},
  { name:'Biotechnology & Modern Biology', wikiCat:'Biotechnology', keywords:[
    'biotech','biotechn','gene','genome','genetic','dna','rna','protein','enzyme','vaccine','cloning','stem cell','crispr','recombinant','transgenic','gm crop','bt cotton','biosimilar','biopharm','molecular','microbial'
  ], topics:[
    'Biotechnology','Genetic engineering','Recombinant DNA','CRISPR gene editing','Gene therapy','Genetically modified crops','Genetically modified food in India','Bt cotton','Bt brinjal','GM mustard','Golden rice','DNA sequencing','Whole genome sequencing','Polymerase chain reaction','Reverse transcription polymerase chain reaction','ELISA','Monoclonal antibody','Vaccine','mRNA vaccine','Inactivated vaccine','Biopharmaceutical','Department of Biotechnology','Genetic Engineering Appraisal Committee','Genome India','Indian SARS-CoV-2 Genomics Consortium','Stem cell','Stem cell therapy','Cloning','Synthetic biology','Bioinformatics','Molecular diagnostics','Biofortification','Nanobiotechnology','Enzyme','Industrial biotechnology','Bioreactor','Xenotransplantation','Antimicrobial resistance'
  ]},
  { name:'Moral Philosophy & Applied Ethics', wikiCat:'Moral_philosophy', keywords:[
    'ethics','moral','virtue','duty','deontolog','consequential','utilitarian','kant','aristotle','mill','rawls','integrity','probity','conscience','value','code of ethics','whistle','conflict of interest','transparency'
  ], topics:[
    'Moral philosophy','Ethics','Virtue ethics','Nicomachean Ethics','Aristotle ethics','Deontological ethics','Categorical imperative','Immanuel Kant','Consequentialism','Utilitarianism','Jeremy Bentham','John Stuart Mill','Hedonism','Stoicism','Epictetus','Marcus Aurelius','Rights-based ethics','Ethics of care','Moral relativism','Moral absolutism','Situation ethics','Applied ethics','Bioethics','Public service ethics','Civil service values','Code of conduct','Integrity','Probity','Transparency (behavior)','Accountability','Conflict of interest','Whistleblowing','Lokpal','Ombudsman','Right to Information','Right to Information Act, 2005','Corporate ethics','Conscience','Character education'
  ]},
  { name:'Kerala Studies & Malayalam Language Paper', wikiCat:'Kerala', keywords:[
    'kerala','malayalam','koch','trivandrum','kozhikode','calicut','kollam','thrissur','backwater','sabarimala','kathakali','theyyam','koodiyattam','muziris','malayali','vaikom','guruvayoor','travancore','cochin','malabar','chera'
  ], topics:[
...
const DAY_GROUPS = [
  ...
  [126,127,128,129,130,131,132,133,134,135], // Group 19: Political Theory & Concepts, Western Political Thought, Indian Political Thought, Comparative Politics & World Constitutions, International Relations Theory, Internal Security & Counter-Terrorism, Financial Regulators & Markets, Biotechnology & Modern Biology, Moral Philosophy & Applied Ethics, Kerala Studies & Malayalam Language Paper
];
