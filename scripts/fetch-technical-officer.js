...
function run() {
  miner.runMiner({
    ...
    topics: {
      'Mathematics & Physics': ['Mathematics', 'Applied mathematics', 'Physics', 'Classical mechanics', 'Thermodynamics', 'Electromagnetism', 'Optics', 'Fluid mechanics', 'Electricity', 'Statics', 'Dynamics (mechanics)'],
      ...
      'Electrical & Electronics': ['Electrical engineering', 'Electronics', 'Electronic circuit', 'Transistor', 'Diode', 'Electrical network', 'Digital electronics', 'Integrated circuit', 'Microcontroller', 'Power electronics'],
